<?php
/**
 * v1.0.52 template re-seed: supportTicketView (admin) — tab switcher for
 * reply vs internal note, and thread rendering that visually distinguishes
 * hidden staff notes.
 */

namespace IPS\gddealer\setup\templates_10052;
