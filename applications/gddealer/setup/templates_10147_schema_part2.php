...
/**
 * v1.0.147 SCHEMA PART 2 of 3 - Example feeds (XML, JSON, CSV).
 *
 * Same as v146 part 2 EXCEPT: the Federal 9mm ammo listing now demonstrates
 * the 4 new optional subfields (fire_type, bullet_design, case_material) so
 * dealers see how to format them. CSV header expanded with the 4 new columns.
 */

if ( !isset( $feedSchemaTpl ) )
{
    throw new \RuntimeException( 'templates_10147_schema_part2.php loaded before part1' );
}
...
076683081124,,"Federal Champion 9mm 115gr FMJ 50rd",Federal,ammo,22.99,,new,https://example-dealer.com/p/federal-9mm-50ct,1,,1,120,9mm Luger,50,centerfire,fmj,brass,,,,,,,,,,,,,,
