...
/**
 * v1.0.146 PART 3 of 3 - Schema page validation rules + closing markup +
 * styles + JS + database write.
 *
 * Appends final markup to $feedSchemaTpl and writes the completed template
 * to core_theme_templates. This must run AFTER part1 and part2.
 */

if ( !isset( $feedSchemaTpl ) )
{
    throw new \RuntimeException( 'templates_10146_part3.php loaded before part1+part2' );
}
...
/* Now write the assembled template to core_theme_templates. */
try
{
...
{
	try { \IPS\Log::log( 'templates_10146_part3.php failed: ' . $e->getMessage(), 'gddealer_upg_10146' ); }
	catch ( \Throwable ) {}
}
