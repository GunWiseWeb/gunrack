<?php
/**
 * v1.0.40 template re-seed: admin disputeQueue + front dealerReviews +
 * front dealerProfile with attachment strip rendering for uploaded-but-
 * not-embedded files (images, PDFs, etc.).
 *
 * Uses the same regex extraction from install.php as v1.0.37/v1.0.38.
 */

namespace IPS\gddealer\setup\templates_10040;
