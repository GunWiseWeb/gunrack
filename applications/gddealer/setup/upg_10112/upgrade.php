<?php
namespace IPS\gddealer\setup\upg_10112;
...
class _upgrade
{
    public function step1(): bool
    {
        ...
        /* Apply v1.0.111 FFL section injection into dashboardCustomize. */
        try { require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10111.php'; }
        catch ( \Throwable $e ) { $errors[] = 'templates_10111.php (FFL section) failed: ' . $e->getMessage(); }

        /* Apply v1.0.112 FFL section rewrite (IPS native classes, strip v10111). */
        try { require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10112.php'; }
        catch ( \Throwable $e ) { $errors[] = 'templates_10112.php (FFL section rewrite) failed: ' . $e->getMessage(); }
        ...
        try { \IPS\Log::log( $errors ? implode( "\n", $errors ) : 'v1.0.112 upgrade completed cleanly', 'gddealer_upg_10112' ); }
        catch ( \Throwable ) {}
