<?php
/**
 * v1.0.62: Re-seed supportList, supportView, supportNew templates
 * to drop the gdDealerWrapper max-width outer constraint so support
 * pages fill the full content area like the other dashboard tabs.
 */
...
$targetNames = [ 'supportList', 'supportView', 'supportNew' ];
