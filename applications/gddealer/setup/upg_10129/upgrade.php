<?php
namespace IPS\gddealer\setup\upg_10129;
...
class _upgrade
{
    public function step1(): bool
    {
        ...
        /* Seed v10128/v10129 lang strings into core_sys_lang_words. data/lang.xml
           only re-imports on fresh install — without this, the Feed Settings
           form renders raw keys instead of human-readable labels. */
        $feedLangStrings = [
        ...
        {
            $errors[] = 'Feed lang seed v10129 failed: ' . $e->getMessage();
        }
        ...
        try { \IPS\Log::log( $errors ? implode( "\n", $errors ) : 'v1.0.129 upgrade completed cleanly', 'gddealer_upg_10129' ); }
        catch ( \Throwable ) {}
