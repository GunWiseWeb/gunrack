<?php
/**
 * v1.0.59: Support new ticket form card-based redesign.
 * Re-seeds supportNew template, clears caches.
 */

namespace IPS\gddealer\setup\upg_10059;
...
class _upgrade
{
	...
	{
		require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10059.php';
