<?php
/**
 * v1.0.52: hidden staff notes — re-seed supportTicketView with tab UI.
 */

namespace IPS\gddealer\setup\upg_10052;
...
class _upgrade
{
	...
	{
		require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10052.php';
