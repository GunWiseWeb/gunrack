<?php
/**
 * v1.0.40: re-seed admin disputeQueue, front dealerReviews, and front
 * dealerProfile templates with attachment strip rendering for uploaded
 * but not embedded files.
 */

namespace IPS\gddealer\setup\upg_10040;
...
class _upgrade
{
	...
	{
		require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10040.php';
