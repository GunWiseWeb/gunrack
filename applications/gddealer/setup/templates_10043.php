<?php
/**
 * v1.0.43 template re-seed: front dealerProfile gains filter/sort dropdowns
 * and an updated template_data signature.
 */

namespace IPS\gddealer\setup\templates_10043;
