<?php
namespace IPS\gddealer\setup\upg_10115;
...
class _upgrade
{
    public function step1(): bool
    {
        ...
        /* Apply v1.0.113 Edit profile restore + FFL re-inject (supersedes 10111+10112). */
        ...
        /* Apply v1.0.114 FFL admin queue + reject form templates. */
        ...
        try { \IPS\Log::log( $errors ? implode( "\n", $errors ) : 'v1.0.115 upgrade completed cleanly', 'gddealer_upg_10115' ); }
        catch ( \Throwable ) {}
