<?php
/**
 * v1.0.48 template re-seed: supportView (dealer) + supportTicketView (admin)
 * — both gain a "Ticket history" timeline block at the bottom.
 */

namespace IPS\gddealer\setup\templates_10048;
...
$targets = [ 'supportView', 'supportTicketView' ];
