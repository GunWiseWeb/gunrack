<?php
namespace IPS\gddealer\setup\upg_10126;
...
class _upgrade
{
    public function step1(): bool
    {
        ...
        try { require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10124.php'; }
        catch ( \Throwable $e ) { $errors[] = 'templates_10124.php (badge card v3 — JSON attr fix) failed: ' . $e->getMessage(); }

        try { require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10125.php'; }
        catch ( \Throwable $e ) { $errors[] = 'templates_10125.php (badge card v4 — JS extracted) failed: ' . $e->getMessage(); }
        ...
        try { \IPS\Log::log( $errors ? implode( "\n", $errors ) : 'v1.0.126 upgrade completed cleanly', 'gddealer_upg_10126' ); }
        catch ( \Throwable ) {}
