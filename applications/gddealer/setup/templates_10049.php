<?php
/**
 * v1.0.49 template re-seed: supportTicketView (admin) + supportView (dealer)
 * — admin: reply form always visible with status banners
 * — dealer: closed tickets show "open a new ticket" message
 */

namespace IPS\gddealer\setup\templates_10049;
...
$targets = [ 'supportTicketView', 'supportView' ];
