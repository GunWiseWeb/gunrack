<?php
/**
 * v1.0.51 template re-seed: supportDepartments + supportDepartmentForm (admin)
 */

namespace IPS\gddealer\setup\templates_10051;
...
$targets = [ 'supportDepartments', 'supportDepartmentForm' ];
