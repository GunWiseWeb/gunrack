<?php
/**
 * v1.0.43: dealer profile review filters + sort.
 *
 * - Re-seed dealerProfile template (updated signature + filter/sort bar).
 */

namespace IPS\gddealer\setup\upg_10043;
...
class _upgrade
{
	...
	{
		require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10043.php';
