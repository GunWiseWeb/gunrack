 ...
 * identical to the old design. v1.0.137 ships the corrected, verified template
    ...
    <div class="directory-hero">
        <div class="hero-top">
            <div class="hero-title-block">
                ...
                <p class="hero-sub">Every dealer on GunRack is a verified FFL holder. Browse, compare, and shop from the dealer that fits your needs.</p>
            </div>
...
{{endif}}
    ...
    <div class="join-banner">
        <div class="join-banner-content">
            ...
            <p class="join-banner-sub">Join GunRack to list your inventory, reach thousands of buyers, and grow your business.</p>
        </div>
...
{
	try { \IPS\Log::log( 'templates_10137.php update failed: ' . $e->getMessage(), 'gddealer_upg_10137' ); }
	catch ( \Throwable ) {}
}
