<?php
/**
 * v1.0.62: Support pages use full content width — re-seeds the
 * three support templates after dropping the gdDealerWrapper
 * max-width outer constraint.
 */

namespace IPS\gddealer\setup\upg_10062;
...
class _upgrade
{
	...
	{
		require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10062.php';
