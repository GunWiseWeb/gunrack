<?php
namespace IPS\gddealer\setup\upg_10119;
...
class _upgrade
{
    public function step1(): bool
    {
        ...
        /* Seed FFL rejection lang strings into core_sys_lang_words.
           lang.xml only auto-imports on fresh install — without this,
           $lang->get() returns the key name or addToStack() leaks hex tokens. */
        $fflLangStrings = [
        ...
        try { \IPS\Log::log( $errors ? implode( "\n", $errors ) : 'v1.0.119 upgrade completed cleanly', 'gddealer_upg_10119' ); }
        catch ( \Throwable ) {}
