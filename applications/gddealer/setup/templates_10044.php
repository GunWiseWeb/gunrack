<?php
/**
 * v1.0.44 template re-seed: front dealerProfile — dropdown option URLs
 * now reference pre-built server-side URLs instead of string concatenation.
 */

namespace IPS\gddealer\setup\templates_10044;
