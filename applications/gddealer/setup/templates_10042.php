<?php
/**
 * v1.0.42 template re-seed: admin disputeQueue gains dropdown filter,
 * collapsible <details> cards with status pills, and cleaned-up structure.
 */

namespace IPS\gddealer\setup\templates_10042;
