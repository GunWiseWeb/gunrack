	...
	<header class="gdHero">
		...
		<div class="gdHero__body">
			...
			<div class="gdHero__rating">
				<div class="gdHero__ratingValue" style="color:{$data['stats']['rating_color']}">{$data['stats']['avg_overall']}</div>
				<div class="gdHero__ratingLabel" style="color:{$data['stats']['rating_color']}">{$data['stats']['rating_label']}</div>
		...
		<div class="gdDealerStats">
			<div>
				...
				<div style="font-size:1.6em;font-weight:800;color:{$data['stats']['rating_color']};line-height:1">{$data['stats']['avg_overall']}<span style="font-size:0.45em;color:#888;font-weight:400"> /5</span></div>
				<div style="font-size:0.72em;font-weight:600;color:{$data['stats']['rating_color']};margin-top:4px">{$data['stats']['rating_label']}</div>
			</div>
			<div>
						...
						<div class="ipsWidget__content i-padding_2" style="padding:16px">
							<div style="margin-bottom:14px">
								<div style="display:flex;justify-content:space-between;margin-bottom:4px">
									...
									<strong style="color:{$data['stats']['color_pricing']}">{$data['stats']['avg_pricing']}/5</strong>
								</div>
								<div style="background:var(--i-border-color,#e0e0e0);border-radius:4px;height:8px">
									<div style="background:{$data['stats']['color_pricing']};border-radius:4px;height:8px;width:{$data['stats']['pct_pricing']}%;transition:width 0.3s ease"></div>
								</div>
							</div>
							<div style="margin-bottom:14px">
								<div style="display:flex;justify-content:space-between;margin-bottom:4px">
									<span style="font-size:0.85em">Shipping Speed</span>
									<strong style="color:{$data['stats']['color_shipping']}">{$data['stats']['avg_shipping']}/5</strong>
								</div>
								<div style="background:var(--i-border-color,#e0e0e0);border-radius:4px;height:8px">
									<div style="background:{$data['stats']['color_shipping']};border-radius:4px;height:8px;width:{$data['stats']['pct_shipping']}%;transition:width 0.3s ease"></div>
								</div>
							</div>
							<div>
								<div style="display:flex;justify-content:space-between;margin-bottom:4px">
									<span style="font-size:0.85em">Customer Service</span>
									<strong style="color:{$data['stats']['color_service']}">{$data['stats']['avg_service']}/5</strong>
								</div>
								<div style="background:var(--i-border-color,#e0e0e0);border-radius:4px;height:8px">
									<div style="background:{$data['stats']['color_service']};border-radius:4px;height:8px;width:{$data['stats']['pct_service']}%;transition:width 0.3s ease"></div>
								</div>
							</div>
						</div>
					</div>
