...
/* Strip the broken v10121 injection (everything from its marker to end of body). */
if ( strpos( $body, 'GD_VERIFIED_BADGE_CARD_v10121' ) !== false )
{
	$body = preg_replace( '#<!-- GD_VERIFIED_BADGE_CARD_v10121 -->.*$#s', '', $body );
}

$marker = '<!-- GD_VERIFIED_BADGE_CARD_v10124 -->';
