<?php
/**
 * v1.0.71: Re-seed dealerShell + seed new dealerSidebar and dealerNavIcon
 * templates for the left-sidebar dashboard redesign.
 */
...
$targetNames = [ 'dealerShell', 'dealerSidebar', 'dealerNavIcon' ];
