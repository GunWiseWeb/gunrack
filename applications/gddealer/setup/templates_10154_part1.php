...
/**
 * v1.0.154 PART 1 of 3 - HTML body of setupWizardStep3.
 *
 * Replaces the v153 template. Adds 3-way source radio per row:
 *   - Map to my field (with dropdown of dealer fields)
 *   - Use default ("new" / "false" / "true" / dealer-overridable)
 *   - Not mapped
 *
 * Initializes $step3Tpl.
 */
	...
	function refreshRow(row) {
		...
		if (sampleCell) {
			if (source === 'feed') {
				...
				var defInp = row.querySelector('input[name^="default["]');
