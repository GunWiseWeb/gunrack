...
/**
 * v1.0.154 PART 2 of 3 - Inline CSS for setupWizardStep3 (with defaults).
 *
 * Appends <style> block to $step3Tpl. Must run after part 1.
 */

if ( !isset( $step3Tpl ) )
{
    throw new \RuntimeException( 'templates_10154_part2.php loaded before part1' );
}
