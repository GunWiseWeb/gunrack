...
<div class="gd-directory">
    ...
    <div class="filters-bar">
        <div class="filters-left">
            ...
            <a class="filter-chip{{if !$tier}} active{{endif}}" href="{$directoryUrl}?sort={$sort}&amp;search={expression="urlencode($search)"}">All</a>
            <a class="filter-chip{{if $tier === 'founding'}} active{{endif}}" href="{$directoryUrl}?tier=founding&amp;sort={$sort}&amp;search={expression="urlencode($search)"}">Founding</a>
            <a class="filter-chip{{if $tier === 'basic'}} active{{endif}}" href="{$directoryUrl}?tier=basic&amp;sort={$sort}&amp;search={expression="urlencode($search)"}">Basic</a>
            <a class="filter-chip{{if $tier === 'pro'}} active{{endif}}" href="{$directoryUrl}?tier=pro&amp;sort={$sort}&amp;search={expression="urlencode($search)"}">Pro</a>
            <a class="filter-chip{{if $tier === 'enterprise'}} active{{endif}}" href="{$directoryUrl}?tier=enterprise&amp;sort={$sort}&amp;search={expression="urlencode($search)"}">Enterprise</a>
        </div>
        ...
        <div class="dealer-card">
            <div class="dealer-head">
                <a href="{$d['profile_url']}" class="dealer-avatar">
                    {{if $d['avatar']}}<img src="{$d['avatar']}" alt="">{{else}}{expression="mb_strtoupper(mb_substr($d['dealer_name'], 0, 1))"}{{endif}}
                </a>
            ...
            <div class="dealer-rating-row">
                ...
                <span class="dealer-rating-value" style="color:{$d['rating_color']}">{$d['avg_overall']}</span>
    ...
    <div class="join-banner">
        <div class="join-banner-content">
            <div class="join-banner-title">Are you an FFL dealer?</div>
            <p class="join-banner-sub">Reach buyers actively comparing prices and shop from your storefront.</p>
        </div>
        <a href="{$joinUrl}" class="join-banner-cta">
            Become a dealer
