<?php
/**
 * v1.0.51: department CRUD — seed admin templates + cache clears.
 */

namespace IPS\gddealer\setup\upg_10051;
...
class _upgrade
{
	...
	{
		require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10051.php';
		...
		try { unset( \IPS\Data\Store::i()->acpMenu ); }         catch ( \Exception ) {}
