<?php
/**
 * v1.0.56: Support list sub-nav with Open/Closed/All filter.
 * Re-seeds supportList template, clears caches.
 */

namespace IPS\gddealer\setup\upg_10056;
...
class _upgrade
{
	...
	{
		require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10056.php';
