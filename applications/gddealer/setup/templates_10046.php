<?php
/**
 * v1.0.46 template re-seed: front dealerShell (Support tab),
 * supportList, supportNew, supportView.
 */

namespace IPS\gddealer\setup\templates_10046;
...
$targets = [ 'dealerShell', 'supportList', 'supportNew', 'supportView' ];
