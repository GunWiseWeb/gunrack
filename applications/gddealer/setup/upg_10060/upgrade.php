<?php
/**
 * v1.0.60: Support list structured grid with navy header + status icons.
 * Re-seeds supportList template, clears caches.
 */

namespace IPS\gddealer\setup\upg_10060;
...
class _upgrade
{
	...
	{
		require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10060.php';
