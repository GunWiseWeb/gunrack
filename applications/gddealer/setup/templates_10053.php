<?php
/**
 * v1.0.53 template re-seed: supportTicketView (stock reply picker + stock
 * actions sidebar), supportStockReplies, supportStockReplyForm,
 * supportStockActions, supportStockActionForm.
 */

namespace IPS\gddealer\setup\templates_10053;
...
$targets = [
	'supportTicketView',
	'supportStockReplies',
	'supportStockReplyForm',
	'supportStockActions',
	'supportStockActionForm',
];
