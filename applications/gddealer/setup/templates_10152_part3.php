...
/**
 * v1.0.152 PART 3 of 3 - Step 2 CSS + database write.
 *
 * Appends inline <style> block to $step2Tpl, then writes the assembled
 * template to core_theme_templates.
 */

if ( !isset( $step2Tpl ) )
{
    throw new \RuntimeException( 'templates_10152_part3.php loaded before part2' );
}
...
{
    try { \IPS\Log::log( 'templates_10152_part3.php failed: ' . $e->getMessage(), 'gddealer_upg_10152' ); }
    catch ( \Throwable ) {}
}
