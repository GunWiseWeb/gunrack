<?php
/**
 * v1.0.44: fix malformed filter URLs on dealer profile.
 *
 * - Re-seed dealerProfile template (dropdown URLs now pre-built server-side).
 */

namespace IPS\gddealer\setup\upg_10044;
...
class _upgrade
{
	...
	{
		require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10044.php';
