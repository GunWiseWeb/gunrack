<?php
/**
 * v1.0.38 admin template re-seed: disputeQueue now accepts
 * ($rows, $filterStatus, $counts, $baseUrl) and renders a
 * status filter bar + archive/collapse for resolved disputes.
 *
 * Uses the same regex extraction from install.php as v1.0.37
 * so install.php remains the single source of truth.
 */

namespace IPS\gddealer\setup\templates_10038;
