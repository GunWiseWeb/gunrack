<?php
namespace IPS\gddealer\setup\upg_10120;
...
class _upgrade
{
    public function step1(): bool
    {
        ...
        try { require_once \IPS\ROOT_PATH . '/applications/gddealer/setup/templates_10120.php'; }
        catch ( \Throwable $e ) { $errors[] = 'templates_10120.php (verified-dealer badge card) failed: ' . $e->getMessage(); }
        ...
        try { \IPS\Log::log( $errors ? implode( "\n", $errors ) : 'v1.0.120 upgrade completed cleanly', 'gddealer_upg_10120' ); }
        catch ( \Throwable ) {}
