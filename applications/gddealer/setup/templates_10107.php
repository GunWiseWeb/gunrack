...
$dealerNavIconBody = <<<'TEMPLATE_EOT'
{{if $icon === 'dashboard'}}
...
try
{
    /* Rule 18: update() keyed on (app, location, group, name) — NO template_set_id.
       This patches every theme's row at once. NEVER use replace() with set_id=0
       because IPS compiles set_id=1 by default and the new content gets ignored. */
    \IPS\Db::i()->update( 'core_theme_templates',
        [
            'template_data'    => '$icon',
            'template_content' => $dealerNavIconBody,
